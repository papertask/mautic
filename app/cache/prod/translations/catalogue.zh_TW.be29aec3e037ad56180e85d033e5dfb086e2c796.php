...
$catalogue = new MessageCatalogue('zh_TW', array (
  ...
  array (
    ...
    'mautic.asset.asset.error.missing.file' => '當選擇本地儲存時，必須上傳一個檔案，然後才能儲存資源。',
    'mautic.asset.asset.error.missing.title' => '資源標題是必填項。',
    'mautic.asset.asset.error.missing.remote.path' => '當選擇遠端儲存時，必須指定遠端的 URL 。',
    'mautic.asset.asset.error.file.size' => '上傳失敗，檔案大小為 %fileSize% MB ，超出最大檔案大小為 %maxSize% MB 的設定。該設定可以在配置選項中修改。',
    'mautic.asset.asset.error.file.extension' => '上傳失敗，因為副檔名 %fileExtension% 不是系統允許的副檔名 (%extensions%)。該設定可以在配置中修改。',
    'mautic.asset.asset.error.file.extension.js' => '上傳失敗，因為副檔名不是可接受的副檔名 (%extensions%)。該設定可以在配置中修改。',
    'mautic.install.database.path.invalid' => '路徑無效或不可寫入',
    'mautic.install.database.path.warning' => '警告！！本路徑位於公共可訪問的 web 根目錄下。不建議採用該設定，因為它可能引起安全風險。建議修改為 %root% 之外的路徑。',
    'mautic.install.database.port.invalid' => '埠號應該為大於 0 的整數。',
    'mautic.install.password.minlength' => '必須至少為 6 個字元',
    'mautic.campaign.form.events.notempty' => '至少需要一個事件。請使用啟動推廣活動生成器按鈕來新增一個事件。',
    'mautic.campaign.form.sources.notempty' => '至少需要一個聯絡人來源。請使用開啟市場活動設計器按鈕來新增一個。',
    'mautic.dashboard.upload.filenotfound' => '未找到所需的檔案',
    'mautic.chat.channel.name.unique' => '姓名已使用。',
    'mautic.chat.channel.name.notblank' => '姓名為必填項。',
    'mautic.point.form.actions.notempty' => '至少需要一個操作。',
    'mautic.point.type.notblank' => '至少必須選擇一個分值操作。',
    'mautic.category.title.notblank' => '標題為必填項。',
    'mautic.api.client.callback.notblank' => '回撥 URI 為必填項。',
    'mautic.api.client.redirecturis.notblank' => '重定向 URI 為必填項。',
    'mautic.api.client.redirecturl.invalid' => '%url% 為無效的 URI。',
    'mautic.page.variant.weight.notblank' => '請輸入本頁面要顯示的獨立點選百分比。',
    'mautic.user.user.email.unique' => '該郵件地址已經被使用。請選擇其它郵件地址。',
    'mautic.user.user.email.valid' => '您輸入的郵件地址無效。',
    'mautic.user.user.firstname.notblank' => '名為必填項。',
    'mautic.user.user.lastname.notblank' => '姓為必填項。',
    'mautic.user.user.password.minlength' => '密碼最少為 6 個字元。',
    'mautic.user.user.password.mismatch' => '密碼不匹配。',
    'mautic.user.user.password.notblank' => '密碼不能為空。',
    'mautic.user.user.passwordreset.notblank' => '需要您的使用者名稱或郵件地址來重設密碼。',
    'mautic.user.user.passwordreset.nouserfound' => '無法找到指定值所對應的使用者。',
    'mautic.user.user.role.notblank' => '必須為該使用者選擇一個角色。',
    'mautic.user.user.username.notblank' => '使用者名稱為必填項。',
    'mautic.user.user.username.unique' => '該使用者名稱已經被使用。請選擇其它使用者名稱。',
  ),
  'messages' => 
  array (
    'mautic.asset.abtest.criteria' => '資源資料',
    'mautic.asset.abtest.criteria.downloads' => '下載率',
    'mautic.asset.abtest.downloads' => '%count% 下載',
    'mautic.asset.abtest.label.downloads' => '下載數',
    'mautic.asset.abtest.label.hits' => '不同資源的下載數',
    'mautic.asset.abtest.label.sentemils' => '傳送的郵件數',
    'mautic.asset.actions' => '資源操作',
    'mautic.asset.asset' => '資源',
    'mautic.asset.asset.error.missing.remote.path' => '當選擇遠端儲存時，必須指定遠端的 URL 。',
    'mautic.asset.asset.form.confirmbatchdelete' => '刪除所選的資源？',
    'mautic.asset.asset.form.confirmdelete' => '刪除資源，%name%?',
    'mautic.asset.asset.form.file.upload' => '上傳檔案 (允許的最大檔案大小 = %max%)',
    'mautic.asset.asset.form.language.help' => '選擇資源語種',
    'mautic.asset.asset.form.remotePath' => '遠端 URL ',
    'mautic.asset.asset.form.storageLocation' => '儲存位置',
    'mautic.asset.asset.form.storageLocation.local' => '本地',
    'mautic.asset.asset.form.storageLocation.remote' => '遠端',
    'mautic.asset.asset.help.alias' => '本資源的 URL 生成採用字元和數字組合 (允許使用連字元) 。若保留空白，則會自動根據現有標題生成唯一的別名。',
    'mautic.asset.asset.menu.edit' => '編輯資源',
    'mautic.asset.asset.menu.new' => '新建資源',
    'mautic.asset.asset.path.relative' => '相對路徑',
    'mautic.asset.asset.preview' => '預覽',
    'mautic.asset.asset.size' => '檔案大小',
    'mautic.asset.asset.submitaction.downloadfile' => '下載一個資源',
    'mautic.asset.asset.submitaction.downloadfile.msg' => '<br />您的下載將在五秒內開始。若未開始，請<a href=\'%url%\'>點選這裡</a>.<script>setTimeout(function(){window.location=\'%url%\';}, 5000);</script>',
    'mautic.asset.asset.submitaction.downloadfile_descr' => '提交表單後下載所選資源。',
    'mautic.asset.asset.thead.download.count' => '下載計數',
    'mautic.asset.asset.url' => '下載 URL',
    'mautic.asset.assets' => '資源',
    'mautic.asset.campaign.event.assets' => '僅限資源',
    'mautic.asset.campaign.event.assets.descr' => '選擇本觸發器所適用的資源。若未選擇任何項，該事件觸發將適用於所有資源。',
    'mautic.asset.campaign.event.download' => '下載資源',
    'mautic.asset.campaign.event.download_descr' => '下載某個資源後觸發操作。',
    'mautic.asset.config.form.allowed.extensions' => '可接受的副檔名',
    'mautic.asset.config.form.allowed.extensions.tooltip' => '逗號分隔的副檔名列表。只有指定副檔名類型的檔案才能上傳。',
    'mautic.asset.config.form.upload.dir' => '資源目錄路徑',
    'mautic.asset.config.form.upload.dir.tooltip' => '設定資源上傳的絕對路徑。%kernel.root_dir% 可被用作公共 web 根目錄下 app 目錄的一個佔位符。建議使用公共 web 根目錄之外的目錄，以避免資源被公開訪問。',
    'mautic.asset.config.form.max.size' => '最大檔案大小 (MB)',
    'mautic.asset.config.form.max.size.tooltip' => '請設定資源上傳時的最大檔案大小，以 MB (Megabytes) 為單位。預設值為 6MB。',
    'mautic.asset.downloadcount' => '下載計數',
    'mautic.asset.drop.file.here' => '拖放檔案至此，或點選這裡以查詢和選擇檔案。',
    'mautic.asset.error.file.failed' => '檔案上傳失敗。',
    'mautic.asset.event.download' => '資源已下載',
    'mautic.asset.filename.local' => '本地檔名',
    'mautic.asset.filename.original' => '原始檔名',
    'mautic.asset.filename.remote' => '遠端檔名',
    'mautic.asset.form.submit.assets' => '資源',
    'mautic.asset.form.submit.assets_descr' => '請選擇要下載的資源。',
    'mautic.asset.graph.line.downloads' => '下載',
    'mautic.asset.graph.pie.statuses' => '下載 HTTP 狀態',
    'mautic.asset.no_audio_support' => '您的瀏覽器不支援語音功能。',
    'mautic.asset.no_video_support' => '您的瀏覽器不支援視訊功能。',
    'mautic.asset.noresults.tip' => '資源指白皮書、PDF 檔案、影象、文件、電子書或任何您希望釋出給客戶的電子文件。想在使用者提交表單後提供某個下載資源？這很簡單！在建立表單時新增“下載一個資源”操作。',
    'mautic.asset.permissions.assets' => '資源 - 使用者可訪問',
    'mautic.asset.permissions.header' => '資源授權',
    'mautic.asset.point.action.assets' => '僅限所選資源',
    'mautic.asset.point.action.assets.descr' => '選擇本操作適用的資源。若未選擇任何項，則適用於所有資源。',
    'mautic.asset.point.action.download' => '下載一個資源',
    'mautic.asset.point.action.download_descr' => '下載資源後更新聯絡人的積分。',
    'mautic.asset.remote.file.browse' => '瀏覽遠端檔案',
    'mautic.asset.remote.no_results' => '未發現遠端檔案。',
    'mautic.asset.remote.select_service' => '請選擇左側的服務。若未列出任何服務，請配置去儲存外掛。',
    'mautic.asset.report.download.code' => '請求碼',
    'mautic.asset.report.download.date_download' => '下載日期',
    'mautic.asset.report.download_count' => '下載計數',
    'mautic.asset.report.downloads.table' => '資源下載',
    'mautic.asset.report.unique_download_count' => '獨立下載計數',
    'mautic.asset.table.most.downloaded' => '下載最多的資源',
    'mautic.asset.table.top.referrers' => '推薦最多者',
    'mautic.campaign.asset.download' => '資源已下載',
    'mautic.config.AssetBundle.upload_dir' => '上傳目錄',
    'mautic.config.tab.assetconfig' => '資源設定',
    'mautic.asset.dashboard.widgets' => '資源控制項',
    'mautic.asset.unique' => '單次',
    'mautic.asset.repetitive' => '重複的',
    'mautic.widget.asset.downloads.in.time' => '及時下載',
    'mautic.widget.unique.vs.repetitive.downloads' => '單次或重複下載',
    'mautic.widget.popular.assets' => '最受歡迎的資源',
    'mautic.widget.created.assets' => '建立資源',
    'mautic.report.group.assets' => '資源',
    'mautic.install.apc.version' => '若要使用 APC，建議使用版本 %minapc% 或更新。您所安裝的版本是 %currentapc% 。請更新您的 APC 擴充套件。',
    'mautic.install.composer.dependencies' => '必須安裝供應商庫。若您執行的是 Mautic 源碼，請執行 \'編輯器安裝\'。如果您安裝的是下載版本，請檢查 \'vendor\' 資料夾',
    'mautic.install.config.unwritable' => 'Mautic 無法將您的配置寫入到適當的位置。請檢查您的檔案系統許可權以確保以下路徑是可讀寫的：<strong>%path%</strong>.',
    'mautic.install.database.installing' => '檢查詳情並建立資料庫。這將需要幾秒鐘。',
    'mautic.install.database.introtext' => 'Mautic 需要連線到資料庫來正常工作。請使用該表單來提供所需要的連線資訊。',
    'mautic.install.date.timezone.not.set' => 'PHP配置中的<strong>date.timezone</strong> 設定未設定。Mautic 已經將預設的時區設定為 \'UTC\' ，我們建議您在 PHP 配置中修改此選項。',
    'mautic.install.detect.unicode' => 'detect_unicode 設定應該在您的 PHP 配置中被關閉。',
    'mautic.install.directory.unwritable' => '%path% 目錄必須可讀寫。請檢查<strong>%path%</strong> 目錄的許可權，確保伺服器可以寫入。',
    'mautic.install.email.header.emailfrom' => '請選擇要傳送的郵件的發件人。',
    'mautic.install.email.header.spooler' => '請選擇郵件的緩衝和傳送設定？',
    'mautic.install.email.introtext' => '配置 Mautic 傳送郵件的方式。',
    'mautic.install.email.subheader.emailfrom' => '選擇發件人姓名和郵件地址。',
    'mautic.install.email.subheader.spooler' => '郵件即可以立即傳送，也可以提交到佇列中，供您手工處理。如果傳送量過大，或與郵件伺服器間的通訊出現延遲，立即傳送可能導致頁面載入的速度降低。 使用佇列時，郵件被置於指定的檔案目錄中，供 cron 作業批量處理。大量傳送時建議採用佇列方式。請閱讀文件以獲得更多資訊。',
    'mautic.install.extension.fileinfo' => '安裝並啟用 <strong>fileinfo</strong> 擴充套件。',
    'mautic.install.extension.imap' => '安裝並啟用 <strong>imap</strong> 擴充套件，以支援郵件監控。',
    'mautic.install.extension.mcrypt' => '安裝並啟用 <strong>mctypt</strong> 擴充套件。',
    'mautic.install.extension.zip' => '安裝並啟用 <strong>zip</strong> 擴充套件。 Mautic 需要啟用該功能來安裝語言包，並進行應用更新。',
    'mautic.install.final.step' => '完成',
    'mautic.install.finalizing' => '正在完成安裝。這將需要幾秒鐘。',
    'mautic.install.form.backup_prefix' => '資料表備份的字首',
    'mautic.install.form.cache_path' => '緩衝目錄路徑',
    'mautic.install.form.database.driver' => '資料庫驅動器',
    'mautic.install.form.database.host' => '主機名',
    'mautic.install.form.database.name' => '資料庫名',
    'mautic.install.form.database.password' => '資料庫密碼',
    'mautic.install.form.database.port' => '資料庫埠',
    'mautic.install.form.database.secret' => '站點的 Secret Value',
    'mautic.install.form.database.table.prefix' => '資料庫表字首',
    'mautic.install.form.database.user' => '資料庫使用者名稱',
    'mautic.install.form.email.auth_mode' => '授權模式',
    'mautic.install.form.email.encryption' => '加密方式',
    'mautic.install.form.email.from_address' => '郵件地址',
    'mautic.install.form.email.from_name' => '姓名',
    'mautic.install.form.email.mailer_host' => '伺服器',
    'mautic.install.form.email.mailer_port' => '埠',
    'mautic.install.form.email.spool_path' => '佇列目錄路徑',
    'mautic.install.form.email.spool_path_descr' => '請輸入郵件佇列的絕對路徑。建議不要將該項置於公眾可訪問的 web 根目錄下。',
    'mautic.install.form.email.spool_type' => '郵件處理方式',
    'mautic.install.form.email.transport' => 'Mailer 傳送',
    'mautic.install.form.email.transport_descr' => '請選擇傳送郵件的方式。Mautic 與這些郵件服務商沒有合作協議，僅在此列出一些服務商以幫助您方便設定 SMTP 配置。',
    'mautic.install.form.existing_tables' => '備份現有的表？',
    'mautic.install.form.existing_tables_descr' => '若設定為否，有衝突的表將會被刪除。',
    'mautic.install.form.log_path' => '日誌目錄路徑',
    'mautic.install.form.none' => '無',
    'mautic.install.form.update_stability' => '最小穩定性',
    'mautic.install.form.user.email' => '郵件地址',
    'mautic.install.form.user.password' => 'Admin 賬戶密碼',
    'mautic.install.form.user.username' => 'Admin 使用者名稱',
    'mautic.install.function.ctypealpha' => '安裝並啟用 <strong>ctype</strong> 擴充套件。',
    'mautic.install.function.iconv' => '安裝並啟用 <strong>iconv</strong> 擴充套件。',
    'mautic.install.function.jsonencode' => '安裝並啟用 <strong>JSON</strong>擴充套件。',
    'mautic.install.function.mbstring' => '安裝並啟用 <strong>mbstring</strong> 擴充套件。',
    'mautic.install.function.pcre' => '安裝並啟用 <strong>PCRE</strong>擴充套件。',
    'mautic.install.function.posix' => '安裝並啟用 <strong>php_posix</strong> 擴充套件 (用於對命令列輸出著色)。',
    'mautic.install.function.sessionstart' => '安裝並啟用 <strong>session</strong> 擴充套件。',
    'mautic.install.function.simplexml' => '安裝並啟用 <strong>SimpleXML</strong> 擴充套件。',
    'mautic.install.function.tokengetall' => '安裝並啟用 <strong>Tokenizer</strong> 擴充套件。',
    'mautic.install.function.xml' => '安裝並啟用 <strong>XML</strong> 擴充套件。',
    'mautic.install.memory.limit' => 'PHP 配置中的 <strong>memory_limit</strong> 設定低於 128MB 的最低限額。大資料量時Mautic 可能會出現記憶體不足的情況。',
    'mautic.install.heading.check.environment' => 'Mautic 安裝 - 環境檢查',
    'mautic.install.heading.configured' => 'Mautic 已成功安裝! 請訪問 <a href=\'https://www.mautic.org/getting-started\' target=\'_blank\'>快速入門</a> 以獲得操作指南。',
    'mautic.install.heading.database.configuration' => 'Mautic 安裝 - 資料庫設定',
    'mautic.install.heading.email.configuration' => 'Mautic 安裝 - 電子郵件配置',
    'mautic.install.heading.final' => 'Mautic 安裝 - 最終環節',
    'mautic.install.heading.finished' => '太好了！',
    'mautic.install.heading.major.problems' => '當前需要解決的最主要問題',
    'mautic.install.heading.minor.problems' => '一些建議',
    'mautic.install.heading.misc.configuration' => 'Mautic 安裝 - 其它',
    'mautic.install.heading.ready' => '準備好安裝！',
    'mautic.install.heading.user.configuration' => 'Mautic 安裝 - 管理員使用者',
    'mautic.install.intl.icu.version' => '請更新您的 intl 擴充套件致最低 ICU 4.0 版本。',
    'mautic.install.magic_quotes_enabled' => '您伺服器上的 PHP  <strong>magic_quotes_gpc</strong> 選項已啟用，請關閉以使用 Mautic。',
    'mautic.install.minimum.php.version' => '您的伺服器不能滿足PHP 的最低需求。Mautic 要求 PHP 版本 %minimum%，而您安裝的版本為 %installed%。請檢查您的主機並更新 PHP 版本。',
    'mautic.install.misc.header.paths' => '日誌和快取的儲存位置？',
    'mautic.install.misc.header.stability' => '設定更新的穩定性路徑',
    'mautic.install.misc.header.url' => '本站點的完整 URL',
    'mautic.install.misc.subheader.paths' => '請輸入一些 Mautic 使用的絕對路徑。建議不要將該項置於公眾可訪問的 web 根目錄下。',
    'mautic.install.misc.subheader.stability' => '您所安裝的Mautic版本不穩定 (如，beta 釋出版本)。Mautic 預設只顯示穩定版本。您也可以選擇最低穩定更新設定，來獲取不穩定版本的更新。例如，通過選取 Beta 渠道，您將只會看到 beta 釋出和穩定釋出。',
    'mautic.install.misc.subheader.url' => '某些功能，如由於聯絡人未進行互動而觸發的一些功能，需要由 cron 作業來觸發。Mautic 需要知道這些例程的站點 URL，以生成正確的著陸頁、資產和轉發 URL。',
    'mautic.install.module.intl' => '安裝並啟用 <strong>intl</strong> 擴充套件。',
    'mautic.install.module.phpxml' => '安裝並啟用 <strong>PHP-XML</strong> 擴充套件。',
    'mautic.install.next.step' => '下一步',
    'mautic.install.password.minlengt' => '密碼長度最少為 6 個字元',
    'mautic.install.pcre.version' => '您應該安裝 PCRE 版本 8.0 或更新。當前您的環境是版本 %pcreversion% 。建議您更新當前的 PCRE 安裝。',
    'mautic.install.pdo.drivers' => '安裝 PDO 驅動',
    'mautic.install.pdo.mandatory' => '必須安裝 PDO 擴充套件',
    'mautic.install.php.version.has.only.security.support' => '您安裝的是 PHP 版本 %phpversion% ，該版本當前只接受安全修訂。這意味著您的版本會很快不被支援。建議您升級到新版本。要了解何種版本的 PHP 當前受到更好的支援，請訪問 <a href=\'http://php.net/supported-versions.php\' target=\'_blank\'> PHP.net</a>.',
    'mautic.install.please.wait' => '請等待',
    'mautic.install.sentence.config.written' => '您的 local.php 配置檔案已經被寫入以下的參數 (in <em>%path%</em>):',
    'mautic.install.sentence.major.problems' => '我們檢測到了 <strong>%majors%</strong> 重要問題。您<em>必須 </em> 解決這些問題，然後才能繼續：',
    'mautic.install.sentence.minor.problems' => '我們檢測到了一些小的問題，<em>建議</em> 您加以修改以改善 Mautic 的使用體驗：',
    'mautic.install.sentence.proceed.to.mautic' => '前往 Mautic ',
    'mautic.install.sentence.ready' => '太好了！您的 Mautic 環境已就緒。',
    'mautic.install.step.1' => '1',
    'mautic.install.step.2' => '2',
    'mautic.install.step.3' => '3',
    'mautic.install.step.4' => '4',
    'mautic.install.step.5' => '5',
    'mautic.install.suhosin.whitelist' => 'Suhosin 未能正確配置，請在PHP配置中增加<strong>phar</strong> 到 <strong>suhosin.executor.include.whitelist</strong> 。',
    'mautic.install.timezone.not.supported' => '您的預設時區不能被 PHP 支援，請檢查 PHP 配置中的拼寫錯誤。',
    'mautic.install.user.introtext' => '請為您的 Mautic 安裝建立管理使用者',
    'mautic.install.xdebug.exception.trace' => 'Xdebug 的 \'show_exception_trace\' 選項應該在PHP 配置中被關閉。',
    'mautic.install.xdebug.nesting' => 'PHP配置中的 <strong>xdebug.max_nesting_level</strong> 應至少設定為 <strong>250</strong> ，以防止 Xdebug 的無限迴圈保護出現致命錯誤。',
    'mautic.install.xdebug.scream' => 'Xdebug 的 \'scream\' 選項應該在PHP 配置中被關閉。',
    'mautic.campaign.add_new_source' => '增加聯絡人來源 ...',
    'mautic.campaign.campaign' => '推廣活動',
    'mautic.campaign.campaign.id' => '推廣活動 ID',
    'mautic.campaign.campaign.addremovelead' => '新增或刪除聯絡人',
    'mautic.campaign.campaign.description' => '<strong>推廣活動描述：</strong> %description%',
    'mautic.campaign.campaign.launch.builder' => '開啟推廣活動生成器',
    'mautic.campaign.campaign.leads' => '新增聯絡人',
    'mautic.campaign.campaigns' => '推廣活動',
    'mautic.campaign.connection.trigger.date.label' => '等待直至  %full%',
    'mautic.campaign.connection.trigger.interval.label' => '等待 %number% %unit%',
    'mautic.campaign.email.send.to.user' => '傳送郵件給使用者',
    'mautic.campaign.event.action.descr' => '一個行動表示某些事被 Mautic 執行 (例如寄送一份郵件)',
    'mautic.campaign.event.action.header' => '行動',
    'mautic.campaign.event.actions.header' => '操作',
    'mautic.campaign.event.addremovelead' => '修改推廣活動',
    'mautic.campaign.event.addremovelead_descr' => '在某個事件被觸發後，將聯絡人新增到特定的市場活動，或從該市場活動中刪除',
    'mautic.campaign.event.condition.header' => '條件',
    'mautic.campaign.event.conditions.header' => '條件',
    'mautic.campaign.event.decision.descr' => '當聯絡人決定採取行動與否時 (例如開啟信件)，需要作出一個決策。',
    'mautic.campaign.event.decision.header' => '決策',
    'mautic.campaign.event.decisions.header' => '決策',
    'mautic.campaign.event.inline.triggerimmediately' => '立即',
    'mautic.campaign.event.inline.triggerinterval' => '+ %interval% %unit%',
    'mautic.campaign.event.last_error' => '最後的執行錯誤',
    'mautic.campaign.event.failed' => '無法針對 %contact% 執行推廣活動事件',
    'mautic.campaign.event.failed.timeline' => '一般錯誤',
    'mautic.campaign.event.intervalunit.choice.d' => '天數(天數)',
    'mautic.campaign.event.intervalunit.choice.h' => '小時(小時數)',
    'mautic.campaign.event.intervalunit.choice.i' => '分鐘(分鐘數)',
    'mautic.campaign.event.intervalunit.choice.m' => '月(月數)',
    'mautic.campaign.event.intervalunit.choice.y' => '年(年數)',
    'mautic.campaign.event.intervalunit.d' => '{0} 天|{1} 天|[2,Inf] 天',
    'mautic.campaign.event.intervalunit.h' => '{0} 小時|{1} 小時|[2,Inf] 小時',
    'mautic.campaign.event.intervalunit.i' => '{0} 分鐘|{1} 分鐘|[2,Inf] 分鐘',
    'mautic.campaign.event.intervalunit.m' => '{0} 月|{1} 月|[2,Inf] 月',
    'mautic.campaign.event.intervalunit.y' => '{0} 年|{1} 年|[2,Inf] 年',
    'mautic.campaign.event.timed.choice.today' => '是今天',
    'mautic.campaign.event.timed.choice.yesterday' => '是昨天',
    'mautic.campaign.event.timed.choice.tomorrow' => '是明天',
    'mautic.campaign.event.timed.choice.anniversary' => '周年',
    'mautic.campaign.event.timed.choice.custom' => '慣例',
    'mautic.campaign.event.leadchange' => '市場活動聯絡人變更',
    'mautic.campaign.event.leadchange_descr' => '當某個聯絡人被新增到或從市場活動中刪除時，觸發操作',
    'mautic.campaign.event.reschedule' => '重排這個事件',
    'mautic.campaign.event.cancel' => ' 取消這個事件 (它以後能夠被重新排定)',
    'mautic.campaign.event.cancelled' => '這個事件已經被取消。請重新排定以恢復原狀。',
    'mautic.campaign.event.systemchanges.header' => '系統變更',
    'mautic.campaign.event.triggered' => '\'%event%\' 事件已觸發',
    'mautic.campaign.event.triggered.description' => '由推廣活動 \'%campaign%\' 中的 %lead% 觸發',
    'mautic.campaign.event.upcoming' => '\'%event%\' 事件觸發',
    'mautic.campaign.event.upcoming.description' => '將由推廣活動 \'%campaign%\' 觸發',
    'mautic.campaign.filter.placeholder' => '聯絡人來源過濾器',
    'mautic.campaign.form.addevent' => '使用右側的列表來新增觸發器和操作到推廣流程。',
    'mautic.campaign.form.addtocampaigns' => '將聯絡人新增到',
    'mautic.campaign.form.confirmbatchdelete' => '刪除所選的推廣活動？',
    'mautic.campaign.form.confirmdelete' => '刪除推廣活動，%name%?',
    'mautic.campaign.form.lead_source' => '聯絡人來源',
    'mautic.campaign.form.limittocampaigns' => '僅限於推廣活動',
    'mautic.campaign.form.limittocampaigns_descr' => '選擇適用本觸發器的推廣活動(表明該觸發器僅對指定的推廣活動有效)。若未選擇任何項，則適用於所有推廣活動。',
    'mautic.campaign.form.modalheader' => '推廣活動事件詳情',
    'mautic.campaign.form.removefromcampaigns' => '從 ... 中刪除聯絡人',
    'mautic.campaign.form.thiscampaign' => '本推廣活動',
    'mautic.campaign.form.trigger_leadchanged' => '當聯絡人 ... 時，執行該操作',
    'mautic.campaign.form.trigger_leadchanged_added' => '已新增',
    'mautic.campaign.form.trigger_leadchanged_removed' => '已刪除',
    'mautic.campaign.form.type' => '執行這個事件 ...',
    'mautic.campaign.form.type_inaction' => '假若聯絡人沒有採取任何行動，執行這個事件 ...',
    'mautic.campaign.form.type.date' => '在特定日期/時間',
    'mautic.campaign.form.type.date_inaction' => '在特定日期/時間前',
    'mautic.campaign.form.type.immediate' => '立即',
    'mautic.campaign.form.type.interval' => '在特定時間範圍',
    'mautic.campaign.form.type.interval_inaction' => '在特定時間範圍內',
    'mautic.campaign.lead.changeowner' => '變更聯絡人擁有者',
    'mautic.campaign.leadsource.form' => '表單',
    'mautic.campaign.leadsource.forms' => '推廣活動表單',
    'mautic.campaign.leadsource.forms.tooltip' => '來自表單提交的聯絡人將被自動新增到這一市場活動。',
    'mautic.campaign.leadsource.header' => '聯絡人來源',
    'mautic.campaign.leadsource.header.singular' => '聯絡人來源',
    'mautic.campaign.leadsource.list' => '分組',
    'mautic.campaign.leadsource.lists' => '聯絡人分組',
    'mautic.campaign.leadsource.lists.tooltip' => '選定組中包含的聯絡人會自動新增到本市場活動中。',
    'mautic.campaign.menu.edit' => '編輯推廣活動',
    'mautic.campaign.menu.index' => '推廣活動',
    'mautic.campaign.menu.new' => '新建推廣活動',
    'mautic.campaign.modify.warning' => '警告：本市場活動已經發布。修改事件或刪除聯絡人群組可能影響正在執行的市場活動。',
    'mautic.campaign.noresults.tip' => '市場活動會導致與聯絡人之間基於設定條件的系列化互動。例如，當聯絡人開啟某個郵件時，您可以傳送一個跟蹤郵件。或當聯絡人點選某個著陸頁時，增加 10 個積分點。 ',
    'mautic.campaign.permissions.campaigns' => '推廣活動 - 使用者可訪問',
    'mautic.campaign.permissions.header' => '推廣活動授權',
    'mautic.campaign.point.trigger' => '推廣活動觸發器',
    'mautic.campaign.point.trigger.changecampaigns' => '修改聯絡人所在的市場活動',
    'mautic.campaign.preview.header' => '預覽',
    'mautic.campaign.rebuild.leads_affected' => '%leads% 聯絡人(組)受影響',
    'mautic.campaign.rebuild.rebuilding' => '為市場活動 %id% 重建聯絡人列表',
    'mautic.campaign.rebuild.no_lists' => '沒有要重建的列表',
    'mautic.campaign.rebuild.not_found' => '推廣活動 #%id% 不存在',
    'mautic.campaign.rebuild.to_be_added' => '總數為 %leads% 的聯絡人(組)被批量新增到 %batch%',
    'mautic.campaign.rebuild.to_be_removed' => '總數為 %leads% 的聯絡人(組)被從 %batch% 批量刪除',
    'mautic.campaign.scheduled' => '推廣活動事件被重新排定',
    'mautic.campaign.trigger.lead_count_processed' => '總數為 %leads% 的聯絡人(組) 在 %batch% 中得以批量處理',
    'mautic.campaign.trigger.scheduled' => '觸發排程事件',
    'mautic.campaign.trigger.triggering' => '推廣活動 %id% 的觸發事件',
    'mautic.campaign.triggered' => '推廣活動已被觸發',
    'mautic.campaign.user.devent.description' => '<strong>事件描述：</strong> %description%',
    'mautic.campaign.user.event.triggered' => '已觸發 <strong>%event%</strong> 事件',
    'mautic.campaign.dashboard.widgets' => '市場活動小工具',
    'mautic.widget.events.in.time' => '事件及時觸發',
    'mautic.widget.leads.added.in.time' => '銷售線索及時新增',
    'mautic.campaign.triggered.events' => '觸發的事件',
    'mautic.config.tab.campaignconfig' => '推廣活動設定',
    'mautic.campaign.command.process.messages' => '處理訊息佇列',
    'mautic.campaign.command.messages.sent' => '訊息被寄送 : %events%',
    'mautic.campaign.lead.addtocompany' => '增加聯絡人到公司',
    'mautic.campaign.event.messages.header' => '訊息',
    'mautic.campaign.event.message.header' => '訊息',
    'mautic.campaign.event.message.descr' => '透過聯絡人的偏好通路寄送訊息',
    'mautic.report.group.campaign_lead_event_log' => '推廣活動',
    'mautic.campaign.events' => '推廣活動事件',
    'mautic.report.campaign.event.name' => '事件名稱',
    'mautic.report.campaign.event.description' => '事件描述',
    'mautic.report.campaign.event.type' => '事件背景',
    'mautic.report.campaign.event.event_type' => '事件類型',
    'mautic.report.campaign.event.trigger_date' => '事件觸發日期',
    'mautic.report.campaign.event.trigger_mode' => '事件觸發模式',
    'mautic.report.campaign.event.channel' => '事件通路',
    'mautic.report.campaign.event.channel_id' => '事件通路 ID',
    'mautic.report.campaign.log.date_triggered' => '事件日誌日期被觸發',
    'mautic.report.campaign.log.is_scheduled' => '事件日誌被排定',
    'mautic.report.campaign.log.trigger_date' => '事件日誌觸發日期',
    'mautic.report.campaign.log.system_triggered' => '事件日誌系統被觸發嗎 ?',
    'mautic.report.campaign.log.channel' => '事件日誌通路',
    'mautic.report.campaign.log.channel_id' => '事件日誌通路 ID',
    'mautic.config.header.index' => '配置',
    'mautic.config.menu.index' => '配置',
    'mautic.config.restricted' => '由系統設定',
    'mautic.config.notwritable' => '配置檔案不可寫入！變更無法儲存。',
    'mautic.sysinfo.header.index' => '系統資訊',
    'mautic.sysinfo.menu.index' => '系統資訊',
    'mautic.sysinfo.tab.phpinfo' => 'PHP 資訊',
    'mautic.sysinfo.tab.folders' => '資料夾 & 檔案許可權',
    'mautic.sysinfo.folders.title' => '下列資料夾和檔案必須可寫入，以便 Mautic 正常工作。',
    'mautic.sysinfo.folder.path' => '資料夾/檔案路徑',
    'mautic.sysinfo.is.writable' => '可寫入',
    'mautic.sysinfo.writable' => '可寫入',
    'mautic.sysinfo.unwritable' => '不可寫入',
    'mautic.sysinfo.tab.log' => '日誌',
    'mautic.sysinfo.log.title' => '當前錯誤日誌',
    'mautic.sysinfo.log.missing' => '今天的 Mautic 錯誤日誌為空。請檢查伺服器錯誤日誌中的錯誤資訊。Mautic 未能捕捉到該資訊。',
    'mautic.sysinfo.phpinfo.missing' => '資訊不可用。伺服器上的 PHP 函數 phpinfo() 被關閉。',
    'mautic.sysinfo.phpinfo.phpversion' => '伺服器上的 PHP 函數 phpinfo() 被關閉。您的 PHP 版本為 <b>%phpversion%</b>.',
    'mautic.dashboard.confirmation_layout_name' => '請為儀表板輸入一個名稱',
    'mautic.dashboard.create.past.tense' => '已建立',
    'mautic.dashboard.delete_layout' => '刪除該佈局？',
    'mautic.dashboard.delete.past.tense' => '已刪除',
    'mautic.dashboard.generated_by' => '由 %name% 生成於 %date%',
    'mautic.dashboard.header.index' => '儀表板',
    'mautic.dashboard.identified.past.tense' => '已識別',
    'mautic.dashboard.ipadded.past.tense' => '已新增的 IP',
    'mautic.dashboard.label.downloads' => '下載',
    'mautic.dashboard.label.hits' => '點選',
    'mautic.dashboard.label.lang' => '語言',
    'mautic.dashboard.label.title' => '標題',
    'mautic.dashboard.menu.index' => '儀表板',
    'mautic.dashboard.update.past.tense' => '已更新',
    'mautic.note.no.upcoming.emails' => '沒有已安排、待發送的郵件。',
    'mautic.dashboard.label.created.leads' => '建立銷售線索',
    'mautic.dashboard.label.url' => 'URL',
    'mautic.dashboard.label.unique.hit.count' => '獨立點選數',
    'mautic.dashboard.label.email.id' => '郵件 ID',
    'mautic.dashboard.label.contact.click' => '點選',
    'mautic.dashboard.label.company.name' => '公司名稱',
    'mautic.dashboard.widget.add' => '新增控制項',
    'mautic.dashboard.export.widgets' => '匯出',
    'mautic.dashboard.widget.import' => '匯入',
    'mautic.dashboard.widget.form.name' => '名',
    'mautic.dashboard.widget.form.type' => '類型',
    'mautic.dashboard.widget.form.width' => '寬度',
    'mautic.dashboard.widget.form.height' => '高度',
    'mautic.dashboard.widget.form.ordering' => '置於 ... 之前',
    'mautic.dashboard.widget.ordering.last' => '上一個',
    'mautic.dashboard.widget.header.edit' => '編輯控制項',
    'mautic.dashboard.widget.header.new' => '新控制項',
    'mautic.dashboard.widget.header.delete' => '刪除控制項',
    'mautic.dashboard.widget.load.time' => '資料在 %time% ms 中載入',
    'mautic.dashboard.widget.data.loaded.from.cache' => '來自緩衝區',
    'mautic.dashboard.widget.data.loaded.from.database' => '來自資料庫',
    'mautic.dashboard.import' => '匯入預定義的儀表盤',
    'mautic.dashboard.predefined' => '預定義的儀表板',
    'mautic.dashboard.import.start.instructions' => '上載預定義的儀表板',
    'mautic.dashboard.widgets.preview' => '預覽選定的預定義儀表板',
    'mautic.dashboard.date.from' => '發件人',
    'mautic.dashboard.date.to' => '至',
    'mautic.dashboard.nowidgets.tip.header' => '您好！',
    'mautic.dashboard.nowidgets.tip' => '您的儀表板中沒有控制項。不用擔心！您可以利用上面的按鈕"新增控制項"，或匯入他人建立的控制項。',
    'mautic.dashboard.missing.permission' => '您無權訪問 %section% 分區的資料。',
    'mautic.dashboard.preview' => '預覽',
    'mautic.chat.channel.form.description' => '簡單描述',
    'mautic.chat.channel.form.isprivate' => '是否私密？',
    'mautic.chat.channel.form.name' => '渠道管理',
    'mautic.chat.channel.header.edit' => '編輯 %name%',
    'mautic.chat.channel.header.new' => '新渠道',
    'mautic.chat.channel.modal.header' => '渠道列表',
    'mautic.chat.channel.notification.header' => '資訊來自 %from%，名稱 %name%',
    'mautic.chat.channel.thead.name' => '管理',
    'mautic.chat.chat.channels' => '渠道',
    'mautic.chat.chat.form.notification_sound' => '聲音提醒',
    'mautic.chat.chat.form.notification_sound.tooltip' => '請設定新聊天資訊抵達時的通知音',
    'mautic.chat.chat.input.placeholder' => '請在此輸入 ...',
    'mautic.chat.chat.new.messages' => '--- 新資訊messages ---',
    'mautic.chat.chat.notification.header' => '資訊來自 %name%',
    'mautic.chat.chat.status.away' => '離開',
    'mautic.chat.chat.status.dnd' => '請勿打擾',
    'mautic.chat.chat.status.idle' => '空閒',
    'mautic.chat.chat.status.manualaway' => '離開',
    'mautic.chat.chat.status.offline' => '離線',
    'mautic.chat.chat.status.online' => '線上',
    'mautic.chat.chat.users' => '直接資訊',
    'mautic.chat.filter.archived' => '已經歸檔',
    'mautic.chat.filter.invisible' => '隱身',
    'mautic.chat.filter.mute' => '關閉聲音',
    'mautic.chat.filter.newmessages' => '有新資訊',
    'mautic.chat.filter.silent' => '關閉通知音',
    'mautic.chat.filter.subscribed' => '註冊了',
    'mautic.chat.header.index' => '聊天資訊',
    'mautic.chat.permissions.archiveother' => '歸檔其它',
    'mautic.chat.permissions.channels' => '渠道 - 使用者可訪問',
    'mautic.chat.permissions.header' => '聊天渠道',
    'mautic.chat.search.more' => '太多結果。請設定其它搜尋詞(組合)。',
    'mautic.chat.setting.archived' => '已歸檔',
    'mautic.chat.setting.notifications' => '提醒',
    'mautic.chat.setting.sound' => '播放聲音',
    'mautic.chat.setting.subscribed' => '已註冊',
    'mautic.chat.setting.visible' => '可見',
    'mautic.chat.sidebar.chat' => '聊天',
    'mautic.chat.sidebar.communication' => '聯絡',
    'mautic.chat.user.modal.header' => '使用者列表',
    'mautic.chat.user.thead.username' => '使用者名稱',
    'mautic.config.tab.chatconfig' => '聊天附加元件設定',
    'mautic.notifications.type.mautic.chat' => '資訊',
    'mautic.chat.channel.new' => '新增',
    'mautic.point.point' => '積分',
    'mautic.point.action.delta' => '改變積分 (+/-)',
    'mautic.point.actions.header.index' => '積分操作',
    'mautic.point.form.addaction' => '使用右側的列表來新增積分操作。',
    'mautic.point.form.confirmbatchdelete' => '刪除所選的積分操作？',
    'mautic.point.form.confirmdelete' => '刪除積分操作，%name%?',
    'mautic.point.form.type' => '當聯絡人 ... ',
    'mautic.point.menu.edit' => '編輯積分操作',
    'mautic.point.menu.index' => '管理操作',
    'mautic.point.menu.new' => '新增積分操作',
    'mautic.point.permissions.header' => '積分許可權',
    'mautic.point.permissions.points' => '積分操作 - 使用者可訪問',
    'mautic.point.permissions.triggers' => '觸發器 - 使用者有權訪問',
    'mautic.point.thead.action' => '操作',
    'mautic.point.thead.delta' => '積分 +/-',
    'mautic.point.trigger.addevent' => '從 ‘新增事件’ 列表中選擇事件。',
    'mautic.point.trigger.event.add' => '新增事件',
    'mautic.point.trigger.form.color' => '聯絡人色彩',
    'mautic.point.trigger.form.confirmbatchdelete' => '刪除所選觸發器？',
    'mautic.point.trigger.form.confirmdelete' => '刪除觸發器， %name%？',
    'mautic.point.trigger.form.modalheader' => '觸發器操作詳情',
    'mautic.point.trigger.form.points' => '最少積分',
    'mautic.point.trigger.form.points_descr' => '觸發相關操作所需要的最少積分。',
    'mautic.point.trigger.header.edit' => '編輯觸發器',
    'mautic.point.trigger.header.index' => '積分觸發器',
    'mautic.point.trigger.header.new' => '新建觸發器',
    'mautic.point.trigger.menu.edit' => '編輯觸發器事件',
    'mautic.point.trigger.menu.index' => '管理觸發器',
    'mautic.point.trigger.tab.events' => '事件',
    'mautic.point.trigger.thead.points' => '總積分',
    'mautic.point.trigger.thead.pointstrigger' => '積分觸發',
    'mautic.points.menu.root' => '積分',
    'mautic.point.dashboard.widgets' => '積分控制項',
    'mautic.widget.points.in.time' => '積分次數',
    'mautic.point.changes' => '積分變化',
    'mautic.calendar.menu.index' => '日曆',
    'mautic.integration.form.feature.cloud_storage' => '連線到雲端儲存',
    'mautic.integration.form.provider.settings' => '供應商設定',
    'mautic.integration.keyfield.amazons3.bucket' => 'Bucket 路徑',
    'mautic.integration.keyfield.OpenCloud.containerName' => '視窗儲存路徑',
    'mautic.integration.keyfield.OpenStack.password' => 'OpenStack 密碼',
    'mautic.integration.keyfield.OpenStack.tenantName' => 'OpenStack 項目名',
    'mautic.integration.keyfield.OpenStack.username' => 'OpenStack 使用者名稱',
    'mautic.integration.keyfield.Rackspace.apiKey' => 'Rackspace API Key',
    'mautic.integration.keyfield.Rackspace.username' => 'Rackspace 使用者名稱',
    'mautic.integration.OpenStack.service.url' => '身份服務 URL',
    'mautic.integration.OpenStack.service.url.tooltip' => '這是指向您 OpenStack 服務身份 API 端點的 URL, 例如： \'https://example.com/v2/identity\'',
    'mautic.integration.Rackspace.server.location' => 'Rackspace 伺服器位置',
    'mautic.integration.Rackspace.server.location.uk' => '英國',
    'mautic.integration.Rackspace.server.location.us' => '美國',
    'mautic.constantcontact.customfield1' => '定製欄位 1',
    'mautic.constantcontact.customfield2' => '定製欄位 2 ',
    'mautic.constantcontact.customfield3' => '定製欄位 3',
    'mautic.constantcontact.customfield4' => '定製欄位 4',
    'mautic.constantcontact.customfield5' => '定製欄位 5',
    'mautic.constantcontact.customfield6' => '定製欄位 6',
    'mautic.constantcontact.customfield7' => '定製欄位 7',
    'mautic.constantcontact.customfield8' => '定製欄位 8 ',
    'mautic.constantcontact.customfield9' => '定製欄位 9',
    'mautic.constantcontact.customfield10' => '定製欄位 10',
    'mautic.constantcontact.customfield11' => '定製欄位 11',
    'mautic.constantcontact.customfield12' => '定製欄位 12 ',
    'mautic.constantcontact.customfield13' => '定製欄位 13',
    'mautic.constantcontact.customfield14' => '定製欄位 14',
    'mautic.constantcontact.customfield15' => '定製欄位 15',
    'mautic.constantcontact.field.address_city' => '城市',
    'mautic.constantcontact.field.address_country_code' => '國家區號 (2 字元)',
    'mautic.constantcontact.field.address_line1' => '地址行  1',
    'mautic.constantcontact.field.address_line2' => '地址行2',
    'mautic.constantcontact.field.address_state' => '州/省',
    'mautic.constantcontact.field.address_postal_code' => '郵政編碼',
    'mautic.constantcontact.field.cell_phone' => '手機號',
    'mautic.constantcontact.field.company_name' => '公司名稱',
    'mautic.constantcontact.field.email' => '郵件地址',
    'mautic.constantcontact.field.fax' => '傳真',
    'mautic.constantcontact.field.first_name' => '名',
    'mautic.constantcontact.field.home_phone' => '家庭電話',
    'mautic.constantcontact.field.job_title' => '職務',
    'mautic.constantcontact.field.last_name' => '姓',
    'mautic.constantcontact.field.prefix_name' => '字首',
    'mautic.constantcontact.field.work_phone' => '工作電話',
    'mautic.icontact.field.business' => '業務電話',
    'mautic.icontact.field.city' => '城市',
    'mautic.icontact.field.email' => '郵件地址',
    'mautic.icontact.field.fax' => '傳真',
    'mautic.icontact.field.firstName' => '名',
    'mautic.icontact.field.lastName' => '姓',
    'mautic.icontact.field.phone' => '電話',
    'mautic.icontact.field.postalCode' => '郵政編碼',
    'mautic.icontact.field.prefix' => '字首',
    'mautic.icontact.field.street' => '地址行  1',
    'mautic.icontact.field.street2' => '地址行2',
    'mautic.icontact.field.suffix' => '字尾',
    'mautic.icontact.field.state' => '州/省',
    'mautic.icontact.keyfield.appid' => 'App ID',
    'mautic.icontact.keyfield.username' => 'App 使用者名稱',
    'mautic.icontact.keyfield.password' => 'App API 密碼',
    'mautic.emailmarketing.list' => '列表',
    'mautic.emailmarketing.list.tooltip' => '選擇銷售線索要新增到的列表',
    'mautic.emailmarketing.list.update' => '選擇列表後會出現銷售線索欄位對映標籤，並隨著列表的切換得以更新。',
    'mautic.emailmarketing.send_welcome' => '發生歡迎郵件',
    'mautic.mailchimp.double_optin' => '啟用 double opt in',
    'mautic.addon.actions' => '擴充套件元件操作',
    'mautic.addon.actions.push_lead' => '推送銷售線索到整合',
    'mautic.addon.actions.tooltip' => '推送某個銷售線索到指定的整合項。',
    'mautic.addon.addons' => '擴充套件元件',
    'mautic.addon.help.searchcommands' => '<strong>搜尋命令</strong><br />is:published<br />is:unpublished',
    'mautic.addon.integration.tab.details' => 'Enabled/Auth',
    'mautic.addon.integration.tab.features' => '熱點',
    'mautic.addon.integration.tab.fieldmapping' => '銷售線索欄位匹配',
    'mautic.addon.manage.addons' => '管理擴充套件元件',
    'mautic.addon.manage.integrations' => '管理整合',
    'mautic.addon.permissions.addons' => '擴充套件元件 - 使用者可訪問',
    'mautic.addon.permissions.header' => '擴充套件元件授權',
    'mautic.addon.point.action' => '擴充套件觸發器',
    'mautic.addon.reload.addons' => '安裝/更新擴充套件元件',
    'mautic.addon.reload.addons.tooltip' => '請通過 FTP 或其它協議上傳擴充套件元件至擴充套件元件目錄，然後點選該按鈕以安裝/升級。',
    'mautic.integration.callbackuri' => '如果可能，請在配置您的應用時使用以下的回撥 URL ( 即返回 URI ) ：',
    'mautic.integration.closewindow' => '關閉視窗',
    'mautic.integration.error.refreshtoken_expired' => '重新整理令牌已經失效。需要重新授權。',
    'mautic.integration.filter.all' => '顯示所有整合',
    'mautic.integration.form.authorize' => '授權 App',
    'mautic.integration.form.enabled' => '已啟用？',
    'mautic.integration.form.feature.public_activity' => '顯示公開活動',
    'mautic.integration.form.feature.public_profile' => '顯示公開設定並啟用設定與銷售線索欄位的匹配',
    'mautic.integration.form.feature.push_lead' => '推送銷售線索到此整合項',
    'mautic.integration.form.feature.settings' => '熱點相關的設定',
    'mautic.integration.form.feature.share_button' => '在著陸頁的社交媒體控制項中顯示分享按鈕',
    'mautic.integration.form.features' => '啟動熱點',
    'mautic.integration.form.field_match_notes' => '紅色星號 (*) 標出的是該整合所需的必選項目。如果銷售線索中的值為空，將會轉遞一個“未知”值。若整合欄位為選擇列表，請確保 Mautic 欄位的列表值與整合項的欄位相匹配。',
    'mautic.integration.form.lead.unknown' => '未知',
    'mautic.integration.form.profile' => '公開設定',
    'mautic.integration.form.reauthorize' => '重新授權 App',
    'mautic.integration.form.savefirst' => '授權所需的金鑰缺失。請輸入金鑰並儲存。',
    'mautic.integration.form.sharebutton' => '分享按鈕',
    'mautic.integration.integrations' => '整合項',
    'mautic.integration.integration' => '整合',
    'mautic.integration.integration.tooltip' => '請選擇要使用的整合',
    'mautic.integration.keyfield.api' => 'API 金鑰',
    ...
    'mautic.integration.leadfield_matches' => '設定可用整合欄位為本地銷售線索欄位',
    'mautic.integration.missingkeys' => '本事務所需要的金鑰不可用。請確認您的設定並重試。',
    'mautic.integration.noresults.tip' => '需要的整合未被找到？請通過擴充套件元件管理器來啟用相關的擴充套件元件！如，要顯示 Facebook 選項，就必須先啟用社交媒體擴充套件元件功能。',
    'mautic.integration.oauth.popupblocked' => '瀏覽器似乎已遮蔽彈出視窗。請啟用本站點的彈出視窗並重試。',
    'mautic.integrations.noresults' => '',
  ),
  'flashes' => 
  array (
    'mautic.asset.asset.error.notfound' => '未找到序號為 %id% 的資源！',
    'mautic.asset.asset.notice.batch_deleted' => '%count% 資源已被刪除！',
    'mautic.installer.error.adding.fields' => '填充聯絡人欄位表時出現錯誤： %exception%',
    'mautic.installer.error.adding.fixtures' => '新增預設資料時發生錯誤： %exception%',
    'mautic.installer.error.connecting.database' => '嘗試連線資料庫時發生錯誤： %exception%',
    'mautic.installer.error.creating.database' => '由於許可權問題，資料庫 %name% 未找到或無法建立。請手工建立資料庫並重試。',
    'mautic.installer.error.creating.user' => '嘗試建立管理員使用者賬號時發生錯誤： %exception%',
    'mautic.installer.error.database.exists' => '您所指定的資料庫已經存在，且包含 Mautic 資料。',
    'mautic.installer.error.installing.data' => '嘗試安裝資料時發生錯誤： %exception%',
    'mautic.installer.error.no.metadata' => '未找到建立資料庫所需的元資料。',
    'mautic.installer.error.writing.configuration' => '在將配置寫入檔案系統時發生錯誤。',
    'mautic.campaign.error.contact_not_in_campaign' => '聯繫人不包含在這個活動',
    'mautic.campaign.error.event_already_executed' => '事件已經被執行 ',
    'mautic.campaign.error.event_must_be_scheduled' => '聯繫人尚未有日誌紀錄時，事件必須被排程或註記為完成',
    'mautic.campaign.error.edit_events.request_invalid' => '物品參數欠缺聯繫人ID或事件ID',
    'mautic.campaign.error.decision_cannot_be_scheduled' => '此決策類型事件無法進行排程',
    'mautic.campaign.error.notfound' => '未找到序號為 %id% 的推廣活動！',
    'mautic.campaign.notice.batch_deleted' => '%count% 個推廣活動被刪除！',
    'mautic.config.config.error.not.updated' => '無法儲存已更新的配置： %exception%',
    'mautic.config.config.notice.updated' => '配置已成功更新',
    'mautic.point.error.notfound' => '未找到序號為 %id% 的分值操作！',
    'mautic.point.notice.batch_deleted' => '%count% 個分值操作已刪除！',
    'mautic.point.trigger.error.notfound' => '未找到序號為 %id% 的觸發器！',
    'mautic.point.trigger.notice.batch_deleted' => '%count% 個分值觸發器已刪除！',
    'mautic.webhook.error.notfound' => 'Webhook 未找到',
    'mautic.category.error.notfound' => '未找到序號為 %id% 的類別！',
    'mautic.category.notice.batch_deleted' => '%count% 個類別已被刪除！',
    'mautic.category.notice.created' => '<strong>%name%</strong> 已建立！',
    'mautic.category.notice.updated' => '<strong>%name%</strong> 已更新！',
    'mautic.form.error.notfound' => '未找到序號為 %id% 的表單！',
    'mautic.form.field.error.notfound' => '未找到序號為 %id% 的表單欄位！',
    'mautic.form.notice.batch_deleted' => '%count% 表單已刪除！',
    'mautic.form.notice.batch_html_generated' => '{0}未重建任何表單。|{1}已重建一個靜音。|]1,Inf[%count% 表單已重建。',
    'mautic.form.submit.error.expired' => '表單在 %date% 日期停止接受提交。',
    'mautic.form.submit.error.pending' => '表單自 %date% 日期開始接受提交。',
    'mautic.form.submit.error.unavailable' => '表單不再可用。',
    'mautic.report.report.error.notfound' => '未找到序號為 %id% 的報表！',
    'mautic.report.report.notice.activated' => '<a href=\'%url%\' data-toggle=\'ajax\' data-menu-link=\'mautic_report_index\'><strong>%name%</strong></a>  已作為主報表被使用！',
    'mautic.report.report.notice.batch_deleted' => '%count% 報表已刪除！',
    'mautic.api.client.error.notfound' => '客戶端未找到， ID 號為 <strong>%id%</strong>.',
    'mautic.api.client.notice.created' => '<a href=\'%url%\' data-toggle=\'ajax\'><strong>%name%</strong></a> 已建立。',
    'mautic.api.client.notice.revoked' => 'API 訪問自應用端啟用，%name%',
    'mautic.api.call.permissionempty' => '至少應提交一項授權',
    'mautic.addon.notice.reloaded' => '%added% 個擴充套件元件已新增，%updated% 個已更新，%disabled% 個已關閉。',
    'mautic.addon.notice.saved' => '針對 %name% 整合的設定已儲存',
    'mautic.integration.auth.invalid.state' => '無效程序，請重試。',
    'mautic.integration.error.addonnotenabled' => '%name% 必須啟用，以檢視相關的整合。',
    'mautic.integration.error.genericerror' => '獲取訪問令牌時發生未知錯誤。',
    'mautic.integration.error.oauthfail' => '授權失敗，返回資訊為，\'%error%\'',
    'mautic.integration.notfound' => '%name% 未找到！',
    'mautic.integration.notice.oauthsuccess' => '授權成功。',
    'mautic.integration.notice.saved' => '設定已儲存',
    'mautic.page.error.notfound' => '未找到序號為 %id% 的頁面！',
    'mautic.page.notice.activated' => '<a href=\'%url%\' data-toggle=\'ajax\' data-menu-link=\'mautic_page_index\'><strong>%name%</strong></a> 已作為主頁面被使用！',
    'mautic.page.notice.batch_deleted' => '%count% 頁面已刪除！',
    'mautic.user.account.notice.updated' => '您的賬號已經更新',
    'mautic.user.auth.error.disabledaccount' => ' 您的賬號已經被凍結。請聯絡站點管理員。',
    'mautic.user.auth.error.invalidlogin' => '無效的登入，請檢查您的登入資訊。',
    'mautic.user.role.error.deletenotallowed' => '%name% 不能被刪除，因為還有使用者在使用。',
    'mautic.user.role.error.notfound' => '無法找到 ID 號為 <strong>%id%</strong> 的角色。',
    'mautic.user.role.notice.batch_deleted' => '%count% 角色已被刪除！',
    'mautic.user.user.error.cannotdeleteself' => '您不能刪除自己的賬號。',
    'mautic.user.user.error.notfound' => '無法找到 ID 號為 <strong>%id%</strong> 的使用者。',
    'mautic.user.user.notice.batch_deleted' => '%count% 使用者已刪除！',
    'mautic.user.user.notice.messagesent' => '您傳送給 %name% 的資訊已發出。',
    'mautic.user.user.notice.passwordreset' => '新的密碼已生成，將通過郵件傳送給您。如果您在未來幾分鐘內未收到，請檢查您的垃圾郵件目錄並/或聯絡系統管理員。',
    'mautic.user.user.notice.passwordreset.success' => '您已經成功重設密碼。現在可以登入了。',
    'mautic.user.user.notice.passwordreset.missingtoken' => '您的密碼重設請求缺少安全令牌。請點選您郵件中的連結。 ',
  ),
  'fixtures' => 
  array (
    'mautic.page.category.events' => '事件',
    'mautic.lead.list.us' => '美國',
    'mautic.lead.list.usalias' => 'us',
    'mautic.lead.field.firstname' => '名',
    'mautic.lead.field.lastname' => '姓',
    'mautic.lead.field.company' => '公司',
    'mautic.lead.field.email' => '郵件地址',
    'mautic.lead.field.position' => '職務',
    'mautic.lead.field.title' => '稱謂',
    'mautic.lead.field.phone' => '電話',
    'mautic.lead.field.mobile' => '手機',
    'mautic.lead.field.fax' => '傳真',
    'mautic.lead.field.address1' => '地址行 1',
    'mautic.lead.field.address2' => '地址行2',
    ...
    'mautic.lead.field.skype' => 'Skype ID',
    'mautic.lead.field.city' => '城市',
    'mautic.lead.field.state' => '州/省',
    'mautic.lead.field.zipcode' => '郵政編碼',
    'mautic.lead.field.country' => '國家',
    'mautic.lead.field.gender' => '性別',
    'mautic.user.role.admin.description' => '可訪問所有內容',
    'mautic.user.role.admin.name' => '管理員',
    'mautic.user.role.limitedsales.description' => '可以建立和擁有銷售線索',
    'mautic.user.role.limitedsales.name' => '銷售助理 - 有限許可權',
    'mautic.user.role.sales.description' => '可訪問市場工具',
    'mautic.user.role.sales.name' => '銷售助理',
    'mautic.user.user.admin.name' => '管理員',
    'mautic.user.user.limitedsales.name' => '有限銷售',
    'mautic.user.user.sales.name' => '銷售',
  ),
));
