...
<head>
    <meta charset="UTF-8" />
    <title><?php echo $view['slots']->get('pageTitle', 'AccessPath'); ?></title>
    ...
    <div class="container" style="margin-top:100px;">
        <div class="row">
            <div class="col-lg-4 col-lg-offset-4">
				...
				<img src="http://pro.accesspath.com/media/images/login_logo.png" style="width:200px; margin:0px 0 0px 0;" />
                        </div>
         ...
         <div class="row">
            <div class="col-lg-4 col-lg-offset-4 text-center text-muted">
                &copy; <?php echo date('Y');?> AccessPath
            </div>
        </div>
    </div>
</section>
